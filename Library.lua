...
function Library:CreateWindow(WindowInfo)
    ...
    -- Ring yang berputar (lingkaran ungu)
    ...
    -- Stroke ring warna ungu (mengikuti AccentColor)
    ...
    -- Buat bentuk lingkaran sempurna
    New("UICorner", {
        CornerRadius = UDim.new(1, 0),
        Parent = Ring,
    })
    
    -- ANIMASI RING BERPUTAR (infinite loop)
    ...
    -- Icon di tengah (tidak ikut berputar)
    ...
    -- Buat Toggle Button dengan ring ungu berputar
    local ToggleButton = {}
    ...
    local RingCorner = New("UICorner", {
        CornerRadius = UDim.new(1, 0),
        Parent = Ring,
    })
    table.insert(Library.Corners, RingCorner)
    ...
    function ToggleButton:SetText(NewText)
        IconImage.Image = NewText
    end
    
    function ToggleButton:SetIcon(NewIcon)
